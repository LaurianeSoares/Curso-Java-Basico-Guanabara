 ...
 */
public class TelaVerificadorIdade extends javax.swing.JFrame {

    /**
     * Creates new form TelaVerificadorIdade
     */
    public TelaVerificadorIdade() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sit = (idade>=16&&idade<18)|| (idade>70)?"OPCIONAL":"NAO E OPCIONAL";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVerificadorIdade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVerificadorIdade().setVisible(true);
            }
        });
    }
